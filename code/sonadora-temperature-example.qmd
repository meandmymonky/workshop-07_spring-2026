...
H~0~: There is an effect of elevation (m) on temperature (°C).

H~A~: There is no effect of elevation (m) temperature (°C).
...
plot(temperature_model) # display diagnostic plots
